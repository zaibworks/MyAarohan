...
export default function AI() {
  ...
  return (
    ...
    >
      ...
      <View className="h-[62px] flex-row items-center justify-between border-b border-[#e1e7eb] bg-white px-[16px] mt-8">
        <View className="min-w-0 flex-row items-center gap-[11px]">
          {/* Menu button */}

          <Pressable
            onPress={() => setDrawerOpen(true)}
            className="h-[38px] w-[38px] items-center justify-center rounded-[11px] border border-[#e1e7eb] bg-white"
          >
            <Menu size={19} color="#16202a" strokeWidth={2} />
          </Pressable>
        ...
        <Pressable
          ...
          className="h-[38px] w-[38px] items-center justify-center rounded-[11px] border border-[#e1e7eb] bg-white"
        >
          <PenLine size={19} color="#16202a" strokeWidth={2} />
        </Pressable>
      </View>
          ...
          <View className="absolute bottom-0 left-0 top-0 z-30 w-[82%] bg-white shadow-2xl">
            ...
            <View className="border-t border-[#e1e7eb] p-[10px]">
              ...
              >
                ...
                <Text className="text-[12.5px] text-[#16202a]">Settings</Text>
              </Pressable>
            </View>
          </View>
        </>
